...
class NeZhaPreTrainedModel(PreTrainedModel):
    """ An abstract class to handle weights initialization and
        a simple interface for downloading and loading pretrained nezha.
    """
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], *model_args, **kwargs):
        ...
        if from_tf:
            ...
            # Make sure we are able to load base nezha as well as derived nezha (with heads)
            start_prefix = ""
            model_to_load = model
            ...
            # Some nezha may have keys that are not in the state by design, removing them before needlessly warning
            # the user.
